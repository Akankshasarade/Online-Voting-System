...
<body>
    ...
    <div class="container" id="container">
        <div class="form-container log-in-container">
            ...
            <form action="/checcred" method="post" onsubmit="return validateForm()">
            <h1>Login</h1>
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-right">
                    ...
                    <p>
                        <h4>One Step Towards Your Goal!</h4>
                    </p>
                     <p class="guide-statement">
				<a href="dash" ><button>Back Home</button></a>
			</p>
                </div>
            </div>
        </div>
